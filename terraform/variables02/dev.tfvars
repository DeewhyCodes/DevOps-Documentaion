...
*/
us_region = "us-east-1"
my_instance_name = "dev_ec2"

/*if file name contains auto (dev.auto.tfvars) OR named as (terraform.tfvars)  it will be automatically loaded my terraform,
if it doesn't contain auto, we can apply the file using {terraform plan/appply -var-file=dev.tfvars}
*/